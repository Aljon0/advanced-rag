...
export function CitationCard({ citation, index }: CitationCardProps) {
  return (
    // Tighter padding and gap on mobile
    <div className="group flex gap-2 sm:gap-3 p-2.5 sm:p-3 bg-gray-50 border border-gray-100 rounded-lg hover:border-gray-200 hover:bg-white transition-all duration-150">
      ...
      <div className="flex-1 min-w-0">
        ...
        {/* Adjusted snippet text size for mobile readability */}
        <p className="text-[11px] sm:text-xs text-gray-600 leading-relaxed border-l-2 border-gray-300 pl-2 italic">
